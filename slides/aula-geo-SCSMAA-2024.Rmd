...
Para isso vamos realizas análise descritiva da variável teor de matéria orgânica do solo na área de eucalipto. ([OLIVEIRA, 2018](https://repositorio.unesp.br/bitstreams/a13ca7aa-da94-4701-89aa-2bd2c8b4442d/download) )
...
Esse conjunto é chamado de **função aleatória (FA)** e é simbolizado por $Z(x_i)$. Na prática, quando retiramos uma amostra de solo em local com coordenadas definidas, temos apenas uma única realização da função aleatória (FA). 
...
#### 15.2) Construa as matrizes de distância e de valor de gamma.
...
recomenda-se um número de pares de ponto em uma dada distância de separação $h$ sempre maior que $30$.
...
### 20) Utilizando o algoritmo da KO, vamos estimar o atributo nos locais não amostrados (gradeado adensado).
