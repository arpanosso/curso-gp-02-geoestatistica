...
Covariância e a correlação são medidas de similaridade entre duas variáveis. Para estender este conceito para medidas de similaridade espacial, considere um gráfico de dispersão em que os pares de dados representam medidas da mesma variável separadas por uma distância $h$ uma da outra. Esta distância é geralmente denominada de `lag`, como usado nas series temporais.
